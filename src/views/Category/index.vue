...
import { useBanner } from './conponents/useBanner'
import { useCategory } from './conponents/useCategory'
// 获取banner数据
const {bennerList} = useBanner()
// 获取分类数据
        ...
        <div class="container m-top-20">
            ...
            <div class="home-banner">
                <el-carousel height="500px">
                    <el-carousel-item v-for="item in bennerList" :key="item.id">
